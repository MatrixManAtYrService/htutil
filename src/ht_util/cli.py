...
def parse_interleaved_args():
    ...
    parser = argparse.ArgumentParser(description="Run a command with ht terminal emulation", add_help=False)
    parser.add_argument("-r", "--rows", type=int, default=20, help="Number of terminal rows")
    parser.add_argument("-c", "--cols", type=int, default=50, help="Number of terminal columns")
    parser.add_argument("--log-level", default="WARNING", help="Log level")
    parser.add_argument("-d", "--delimiter", default=",", help="Delimiter for parsing keys")
