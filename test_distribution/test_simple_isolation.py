...
class TestWheelVenvInstallation:
    ...
    def test_wheel_installs_successfully(self, wheel_path):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert ("Successfully installed" in result.stdout and "htty" in result.stdout), "Expected successful installation message"
...
class TestConsistency:
    ...
    def test_both_install_same_scripts(self, wheel_path, sdist_path):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert expected_scripts.issubset(wheel_scripts), f"Missing expected scripts: {expected_scripts - wheel_scripts}" 